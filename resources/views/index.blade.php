...
<body class="h-full flex flex-col items-center justify-center p-6 text-center text-white font-sans antialiased">
    ...
    <div class="max-w-5xl w-full space-y-12 animate-fade-in relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('ai.text-to-speech') }}" class="group relative bg-gray-800 hover:bg-gray-750 border border-gray-700 hover:border-pink-500/50 rounded-2xl p-6 transition-all duration-300 hover:shadow-xl hover:shadow-pink-500/10 hover:-translate-y-1">
                <div class="flex items-center gap-4 mb-2">
                    <div class="bg-pink-500/10 p-2 rounded-lg group-hover:bg-pink-500/20 transition-colors">
                    ...
                    <span class="font-semibold text-lg text-white">Text to Speech</span>
                </div>
                <p class="text-sm text-gray-400 text-left">Convert your text into lifelike speech using AI.</p>
            </a>

            <a href="{{ route('ai.vision') }}" class="group relative bg-gray-800 hover:bg-gray-750 border border-gray-700 hover:border-orange-500/50 rounded-2xl p-6 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/10 hover:-translate-y-1">
                <div class="flex items-center gap-4 mb-2">
                    <div class="bg-orange-500/10 p-2 rounded-lg group-hover:bg-orange-500/20 transition-colors">
                    ...
                    <span class="font-semibold text-lg text-white">Vision</span>
                </div>
